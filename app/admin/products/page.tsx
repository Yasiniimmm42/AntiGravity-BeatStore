...
export default function AdminProducts() {
  ...
  if (loading) return <div style={{ padding: '20px', color: 'var(--muted)' }}>Ürünler yükleniyor...</div>;

  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px' }}>
        <h1 style={{ margin: 0, fontSize: '28px', fontWeight: 700, letterSpacing: '-0.5px' }}>Ürünler</h1>
        <Link href="/admin/upload" className="btn-primary" style={{ padding: '10px 18px', fontSize: '14px' }}>
      ...
      <div style={{ display: 'grid', gap: '15px' }}>
        {beats.length === 0 && (
          <div className="admin-card" style={{ padding: '40px', textAlign: 'center', color: 'var(--muted)' }}>
            Henüz yüklenmiş bir ürün yok.
          </div>
        )}
