      ...
      <div style={{ display: 'grid', gap: '15px' }}>
        ...
        {beats.map((beat, index) => (
          ...
          >
            ...
            <div style={{ fontSize: '16px', fontWeight: '600', minWidth: '80px', textAlign: 'right', color: 'var(--foreground)' }}>
        ...
        {editingBeat && (
          ...
          >
            <motion.div 
              ...
              className="glass" 
              style={{ padding: '30px', width: '100%', maxWidth: '400px', border: '1px solid var(--border)', borderRadius: '16px' }}
            >
              ...
              <form onSubmit={handleUpdate} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <div style={{ display: 'flex', gap: '16px' }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <label style={{ display: 'block', marginBottom: '8px', fontSize: '13px', color: 'var(--muted)', fontWeight: 500 }}>Fiyat (TL)</label>
                    <input type="number" step="0.01" required value={editingBeat.price} onChange={e => setEditingBeat({...editingBeat, price: Number(e.target.value)})} />
                  </div>
                </div>
